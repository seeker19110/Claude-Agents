...
| Nguồn | Đích | Ghi chú |
|---|---|---|
| `agents/<block>/<id>.md` | `.claude/agents/sc-<id>.md` | 12 agent hiện có, dẫn xuất máy móc |
...
- Không gộp trợ lý vào 12 agent của công ty: khác phía gate, khác quyền, khác vòng đời.
