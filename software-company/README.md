...
```
docs/          kiến trúc, tiêu chuẩn, ADR (0001–0030); reports/ = báo cáo mô phỏng (donghanhcungban: client giả + bản relay model thật)
...
### Đã có
- Tài liệu: kiến trúc, tiêu chuẩn, ADR 0001–0030; 20 system prompt có version; 45 skill có version; 14 template; checklist 4 gate + escalation.
