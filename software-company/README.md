...
```
docs/          kiến trúc, tiêu chuẩn, ADR (0001–0032); reports/ = báo cáo mô phỏng (donghanhcungban: client giả + bản relay model thật)
...
### Đã có
- Tài liệu: kiến trúc, tiêu chuẩn, ADR 0001–0032; 20 system prompt có version; 45 skill có version; 14 template; checklist 4 gate + escalation.
