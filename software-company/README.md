...
```
docs/          kiến trúc, tiêu chuẩn, ADR (0001–0036); reports/ = báo cáo mô phỏng (donghanhcungban: client giả + bản relay model thật)
...
tests/         pytest 972 ca / 56 file (bus, registry↔events, delivery+gates, supervisor, orchestrator, release flow, nhánh
...
### Đã có
- Tài liệu: kiến trúc, tiêu chuẩn, ADR 0001–0036; 21 system prompt có version; 45 skill có version; 14 template; checklist 4 gate + escalation.
