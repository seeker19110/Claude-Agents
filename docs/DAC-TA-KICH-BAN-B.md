...
| K3.6d2 | **xong** | #PR | `AgentRunner` (phần ngoài) lên xagents_core — **K3.6 xong**. Nguyên tắc: cơ chế lên core, hành vi mỗi công ty giữ nguyên từng byte. Hai chỗ đổi hành vi studio âm thầm (`wants_content`, `_new_envelope`) giải bằng tham số. Đo hai chiều để lộ lỗ hổng: đột biến làm core đỏ mà studio xanh → đã thêm ca chốt hành vi ở studio |
