...
| K3.6d2, K3.7 | chưa | | d2 = `AgentRunner` (difflib 0.14, 411/202 dòng) — phần lớn còn lại của kịch bản B | b `blackboard`, c `evals`, d `runner`; K3.e (≥ 5 ngày lịch sau K3.5) là điều kiện của người, test xanh không đóng được |
