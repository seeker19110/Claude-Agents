...
| N5 | ADR core và code: `quality:accept` chạy lại được khi candidate sha đổi sau `SUCCEEDED` (attempt mới ràng sha mới, giữ lịch sử) | core/company | pe2-noi2 | C3 | Nghiệm thu lại không cần ký profile mới | Đổi máy trạng thái ADR-0017 | ◐ PR pe2-noi2 (ADR-0022 Accepted) |
