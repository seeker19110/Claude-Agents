...
|---|---|---|---|---|---|---|---|
| P0 | pr-policy chặn DoD và khối xác thực còn `- [ ]`; rút gọn đoạn trong `AGENTS.md` | ci/docs | pe2-quytrinh | C1 | Rẻ, chặn lặp lại P2 của #335 | PR cũ đang mở phải sửa thân | ◐ PR #337 |
