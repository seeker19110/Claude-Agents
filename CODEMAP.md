...
| Đổi cách orchestrator chạy nghiệm thu quality, gap R6 hay khối console | `companies/software-company/src/company/orch/quality_flow.py`, `orch/quality_release.py`, `quality_floor.py` (R6), `gate_cli.py` (`--quality-profile`), `platform/console/src/console/quality.py`, ADR-0021 | `scripts/dev-task.sh gate company`, `scripts/dev-task.sh gate console` |
