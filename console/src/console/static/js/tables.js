/* tables.js — tách từ index.html ở K7.1 (kịch bản B). Không build step, không CDN.
    */
import {openTicket} from "./drawer.js";
import {GW, SC, emptyBox, emptyRow, listOf, srcOk, srcWhy, st} from "./state.js";
import {retry} from "./stream.js";
import {filter} from "./tiles.js";
import {renderReleases} from "./truth.js";
import {$, Q, esc, hay, hl, kb, num, sortRows} from "./util.js";
...
export const boardFilter={tickets:"all"};
...
export function renderBoards(){
  const tickets=listOf(SC,st().tickets);
...
[["#f-tickets","tickets"]].forEach(([host,key])=>{
