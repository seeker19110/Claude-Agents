---
name: sc-support-docs
description: >-
  Trợ lý kiểm duyệt — chuẩn bị bằng chứng theo góc nhìn support-docs. Chỉ đọc, không quyết định. Cập nhật tài liệu (Diátaxis), changelog (Keep a Changelog); tiếp nhận incident/feedback, phân loại SEV, tạo ticket mới.
tools: Read, Grep, Glob
model: sonnet
---

<!-- SINH TỰ ĐỘNG từ agents/operations/support-docs.md version=9 — sửa nguồn rồi chạy make subagents -->
...
## Tiêu chuẩn của support-docs (nguồn: agents/operations/support-docs.md)
