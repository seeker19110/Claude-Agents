...
<!-- SINH TỰ ĐỘNG từ agents/engineering/platform.md version=8 — sửa nguồn rồi chạy make subagents -->
...
`tasks` có assignee=platform, hoặc `test-suites` của ticket được giao cho bạn.
