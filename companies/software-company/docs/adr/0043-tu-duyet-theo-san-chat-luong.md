...
§1 được sửa bởi ADR gốc 0024 (`docs/adr/0024-nguoi-duyet-gate-khong-phai-nguoi.md`, được chấp nhận 2026-09-26): ngoài người, reviewer `reviewer:<id>` có chữ ký Ed25519 được `approve` escalation ticket/dự án, mỗi subject một lần, khi bật `COMPANY_GATE_REVIEWER`. Spec, release, acceptance, nợ kiến trúc, reject/close: giữ nguyên như dưới đây.
