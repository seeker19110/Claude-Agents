...
| [`platform/xagents-core/`](platform/xagents-core/) | Lõi chung của mọi công ty AI: bus, llm, runner, guard, gate, **execution harness kernel** — company import từ đây thay vì tự fork | mypy `strict` + phủ 100% dòng VÀ 100% nhánh từ ngày đầu, 541 test; execution contract/state/journal theo ADR gốc 0017, mở đường để phiên chính làm director thay vì giữ execution state trong context |
